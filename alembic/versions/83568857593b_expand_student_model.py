...
Revision ID: 83568857593b
Revises: 20260427_0001
Create Date: 2026-05-03 15:47:05.805353
...
def upgrade() -> None:
    ...
    op.add_column('students', sa.Column('university_id', sa.String(length=20), nullable=False))
    ...
    op.add_column('students', sa.Column('status', sa.String(length=20), nullable=False))
