...
import { GraduationCap, ArrowLeft, Mail, Lock, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Send JSON with 'email' and 'password' as expected by the backend
        ...
        <div className="bg-card border border-border rounded-[2.5rem] shadow-2xl shadow-primary/5 p-8 md:p-10">
          <div className="flex flex-col items-center text-center gap-4 mb-8">
            ...
            <div className="flex flex-col gap-1">
              <h1 className="text-2xl font-black tracking-tight">{t('login_title')}</h1>
